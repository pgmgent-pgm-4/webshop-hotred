...
const updatePaymentMethod = async (req, res, next) => {
  try {
    ...
    // Get specific payment from database
    const payment = await database.payment_methods.findByPk(paymentId);
    ...
    const model = req.body;
    const updatedPost = await database.payment_methods.update(model, {
      where: {
        id: paymentId,
      },
    });
...
export {
  createPaymentMethod, deletePaymentMethod, getPaymentMethodById, getPaymentMethods, updatePaymentMethod,
};
